...
public:
    ...
    EntityRpcManager(enum EntityType entity_type, const GString& entity_class_name, const function<Entity*()>& creator) {
        ...
        if (entity_type == EntityType::EntityType_Base) {
            ...
            entity_rpc_regist(RpcType::EXPOSED,     "on_client_reconnect_success",  &BaseEntityWithClient::on_client_reconnect_success, GString());
        }
            ...
            entity_rpc_regist(RpcType::EXPOSED,     "on_client_reconnect_success",  &BaseEntityWithCellAndClient::on_client_reconnect_success, GString());
            ...
            entity_rpc_regist(RpcType::EXPOSED,     "on_client_reconnect_success",  &CellEntityWithClient::on_client_reconnect_success, GString(), GString(), GString());
